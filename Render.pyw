...
class Window(DarkOrange):
    ...
    def writeBatFile(self,do = "single",task = None):
        ...
        if not any(self.isSettingChanged()):
 ...
 "+scnFile
    ...
    def locateMelFile(self):
        ...
        fname=QtGui.QFileDialog.getOpenFileName(self,'Open File',self.userDir,self.tr("Mel Script( *.mel )"))#,self.directory,self.tr("Mel Script( *.mel )"))
        return fname
